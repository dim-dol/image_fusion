...
def image_process():
    ...
    ir = cv2.imread('../dataset/dataset_eoir/IR/' + str(image_num) + '.png', cv2.IMREAD_GRAYSCALE)
    eo = cv2.imread('../dataset/dataset_eoir/EO/' + str(image_num) + '.png', cv2.IMREAD_COLOR)
...
image1 = cv2.imread('../dataset/dataset_eoir/EO/0.png', cv2.IMREAD_COLOR)
image2 = cv2.imread('../dataset/dataset_eoir/EO/0.png', cv2.IMREAD_COLOR)
image3 = cv2.imread('../dataset/dataset_eoir/EO/0.png', cv2.IMREAD_COLOR)
image4 = cv2.imread('../dataset/dataset_eoir/EO/0.png', cv2.IMREAD_COLOR)
image5 = cv2.imread('../dataset/dataset_eoir/EO/0.png', cv2.IMREAD_COLOR)
image6 = cv2.imread('../dataset/dataset_eoir/EO/0.png', cv2.IMREAD_COLOR)
image7 = cv2.imread('../dataset/dataset_eoir/EO/0.png', cv2.IMREAD_COLOR)
image8 = cv2.imread('../dataset/dataset_eoir/EO/0.png', cv2.IMREAD_COLOR)
